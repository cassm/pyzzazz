...
class GuiControllerWindow:
    def __init__(self, name, buttons, sliders):
        ...
        for butt in buttons:
            self._buttons[butt["id"]] = Control(butt["name"], butt["id"], butt["target_regex"], butt["command"])
        ...
        for slider in sliders:
            self._sliders[slider["id"]] = Control(slider["name"], slider["id"], slider["target_regex"], slider["command"])
